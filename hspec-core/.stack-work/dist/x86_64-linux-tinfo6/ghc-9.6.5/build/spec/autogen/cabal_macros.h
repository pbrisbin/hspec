...
/* package base-orphans-0.9.2 */
#ifndef VERSION_base_orphans
#define VERSION_base_orphans "0.9.2"
...
/* package hspec-meta-2.11.9 */
#ifndef VERSION_hspec_meta
#define VERSION_hspec_meta "2.11.9"
#endif /* VERSION_hspec_meta */
#ifndef MIN_VERSION_hspec_meta
#define MIN_VERSION_hspec_meta(major1,major2,minor) (\
  (major1) <  2 || \
  (major1) == 2 && (major2) <  11 || \
  (major1) == 2 && (major2) == 11 && (minor) <= 9)
#endif /* MIN_VERSION_hspec_meta */
...
/* package silently-1.2.5.3 */
#ifndef VERSION_silently
#define VERSION_silently "1.2.5.3"
...
#define CURRENT_COMPONENT_ID "hspec-core-2.11.9-E4Z2mDtTQ9w9rLROkVoUqs-spec"
