...
/* package mockery-0.3.5 */
#ifndef VERSION_mockery
#define VERSION_mockery "0.3.5"
#endif /* VERSION_mockery */
#ifndef MIN_VERSION_mockery
#define MIN_VERSION_mockery(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  3 || \
  (major1) == 0 && (major2) == 3 && (minor) <= 5)
#endif /* MIN_VERSION_mockery */
...
#define CURRENT_COMPONENT_ID "hspec-discover-2.11.9-AVUUDENb6cb5EhGwB53Vkf-spec"
